...
export default function UserCard({ user }) {
  return (
    <div className="bg-white dark:bg-[#1a1f2e] p-4 border-b border-gray-100 dark:border-gray-800 flex items-start gap-3">
      ...
      <div 
        className="w-10 h-10 rounded-full bg-gradient-to-tr from-indigo-500 to-purple-500 flex items-center justify-center text-white font-bold flex-shrink-0 overflow-hidden"
      ...
      <div className="flex-1 min-w-0">
        <div className="flex justify-between items-center">
          ...
          <span className={`text-xs px-2 py-1 rounded-full font-medium border whitespace-nowrap ml-2
